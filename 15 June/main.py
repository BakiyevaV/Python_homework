...
if __name__ == "__main__":
    ...
    # room = Room(21)
    # lux_apartments_rooms.gen_rooms()
    # Visitor1 = Person("Питер","Гриффин","21-10-1975", 10000,"2023-08-01","2023-08-14", 2)
    # lux_apartments.get_price()
    # print(lux_apartments.buy_order())
    # lux_apartments.check_in("Питер","2023-08-01", )
